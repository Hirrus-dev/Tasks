		...
		try {
			...
			if ( strcasecmp( 'predis', $client ) === 0 ) {
				...
				if ( ! class_exists( 'Predis\Client' ) ) {
					require_once WP_CONTENT_DIR . '/predis.php';
				...
				if ( defined( 'WP_REDIS_SERVERS' ) ) {
					...
					#$parameters = ['tcp://cache-1:6379?database=15&alias=master', 'tcp://cache-2:6379?database=15&alias=slave-01'];
					$options = [
						'replication' => true,
						'parameters' => [
